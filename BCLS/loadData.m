function [Data_ori, gt, c] = loadData(data, dataset_name, max_points,cluse_num, seed)
     ...
     switch data
       ...
       case 'yale-b'
         ...
         case 'Balance_EXP'
             file_path =strcat("\path\to\data\file", dataset_name, "_", num2str(max_points), "_", num2str(cluse_num), ".csv");
