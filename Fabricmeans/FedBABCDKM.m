...
function [Y, minO, iter_num, sse, obj, balance_loss, elapsed_time] = FedBABCDKM(X, label,c, block_size, rho, numWorkers, max_iters, seed,israndom)
fprintf("FedBABCDKM\n");
[~,n] = size(X);
