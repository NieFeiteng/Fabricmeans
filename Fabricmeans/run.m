...
methods = {'Fabricmeans','Fabricmeans-DP','CDKM', 'kmeansPP'};
clusters_sets = {4};
                ...
                for rho_idx = 1:length(rho_sets)
                    ...
                    for epsilon_idx = 1:length(epsilon_set)
                        for block_sizes_idx = 1:length(block_sizes)
                            ...
                            file_path = strcat('\path\to\file\', dataset_name, '_', num2str(max_points), '_', num2str(c), '.csv');
                            ...
                            for ite_run = 1:num_runs
                                ...
                                switch method_name
                                    ...
                                    case 'CDKM'
                                        ...
                                        obj = sse;
                                    case 'Fabricmeans'
                                        [Y_label, ~, iter_num, sse, obj,balance_loss, elapsed_time] = Fabricmeans(X, label, c, block_size, t, iter_rounds);
                                    case 'Fabricmeans-DP'
                                        [Y_label, ~, iter_num, sse, obj,balance_loss, elapsed_time] = Fabricmeans_DP(X, label, c, block_size, t, iter_rounds,epsilon);
